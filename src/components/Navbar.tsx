          ...
          <nav className="flex items-center gap-1 h-12">
            {navLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-orange-500 hover:bg-orange-50 rounded-md transition-colors"
              >
                {link.label}
              </Link>
            ))}
            <div className="ml-auto">
              <Link href={`/${locale}/account`} className="px-4 py-2 text-sm font-medium text-gray-500 hover:text-orange-500 transition-colors">
